...
class StudyForm(forms.ModelForm):
    ...
    study_membernum = forms.TypedChoiceField(
        label='모집 인원',
    ...
    post_content = forms.CharField(
        ...
        label='내용',
        help_text='추천 스터디 지우고 다른 내용을 작성 가능',
    )
    ...
    class Meta:
        model = Study
        exclude = ['author']
        fields = ["post_title", "user_major", "user_grade", "study_type", "study_membernum", "post_content"]
